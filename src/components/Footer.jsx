...
const style = {
  wrapper:
    "border-t border-gray-500 text-foreground bg-background px-8 pt-12 pb-6 w-full",
        ...
        <div className={style.secondwrapper}>
          ...
          <div>
            ...
            <p className="text-sm lg:text-md text-gray-500 dark:text-gray-400 mt-1 ">
              Tourism Forecasting for Nepal. Explore historical trends,
              forecasts, and side by side comparisons to make sense of visitor
              data.
            </p>
            <div className="flex gap-2 mt-5">
              <a
                href="https://github.com/NilishaShrestha000/Capstone"
                target="_blank"
              ...
              <a
                href="https://www.linkedin.com/school/iimscollege/posts/?feedView=all"
                target="_blank"
                className={style.border}
              >
                <FaLinkedin />
          ...
          <div className="grid grid-cols-2">
            ...
            <div>
              ...
              <div className="flex flex-col gap-1 ">
                <Link to="/historical" className={style.links}>
                  <IoIosTimer /> Historical
                </Link>
                <Link to="/forecast" className={style.links}>
                  <IoMdTrendingUp />
                  Forecast
                </Link>
                <Link to="/comparison" className={style.links}>
                  <BiBarChartAlt2 />
                  Comparison
                </Link>
              </div>
            ...
            <div>
              ...
              <div className="flex flex-col gap-1 ">
                <Link to="/aboutus" target="_blank" className={style.links}>
                ...
                <Link to="/termsofuse" target="_blank" className={style.links}>
                  <IoMdPaper /> Terms of Us
                </Link>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex flex-col gap-1 ">
              <a
                href="https://maps.app.goo.gl/NQAmiiZy3m9znYr27"
                target="_blank"
                className={style.links}
              >
                <GrMapLocation />
                Naxal Bhagwatibahal, Kathmandu
              </a>
              <a
                href="https://wa.me/9779863034097"
                target="_blank"
              ...
              <a
                href="https://maps.app.goo.gl/98SqcfqyT7KjcsDv7"
                target="_blank"
                className={style.links}
              >
                <LuBuilding2 /> IIMS College
              </a>
            </div>
          </div>
        </div>
